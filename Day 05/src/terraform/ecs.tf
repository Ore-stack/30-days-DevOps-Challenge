...
resource "aws_ecs_task_definition" "this" {
  ...
  container_definitions = templatefile("${path.module}/container_definitions.tpl", {
    ...
    rapidapi_ssm_parameter_arn = "arn:aws:ssm:us-east-1:575108946734:parameter/myproject/rapidapi_key"
    mediaconvert_endpoint      = var.mediaconvert_endpoint
    mediaconvert_role_arn      = "arn:aws:iam::575108946734:role/HighlightProcessorRole"
  })
}
